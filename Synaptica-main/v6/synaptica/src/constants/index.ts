...
export const NAV_GROUPS = [
  {
    ...
    color: '#10b981',
    links: [
      { label: 'Algorithm Library',  path: '/algorithms',  desc: '68+ algorithms with deep dives' },
      { label: 'Learning Paths',     path: '/learning',    desc: 'Beginner to expert structured paths' },
      { label: 'ML Timeline',        path: '/timeline',    desc: '1943–2024 history of ML' },
      { label: 'Live Lab',           path: '/lab',         desc: '5 interactive experiments' },
    ],
  },
  {
    label: 'Reference',
    color: '#22d3ee',
    links: [
      { label: 'Cheat Sheets',       path: '/cheatsheets', desc: 'Quick-reference algorithm cards' },
      { label: 'Formula Sheet',      path: '/formulas',    desc: '35 key ML formulas explained' },
      { label: 'Glossary',           path: '/glossary',    desc: '60+ ML terms defined clearly' },
      { label: 'Must-Read Papers',   path: '/papers',      desc: '35 curated research papers' },
    ],
  },
  {
    label: 'Tools',
    color: '#f59e0b',
    links: [
      { label: 'Compare Algorithms', path: '/compare',     desc: 'Side-by-side comparison tool' },
      { label: 'Interview Prep',     path: '/interview',   desc: '1000+ Q&A + mock interviews' },
      { label: 'Which Algorithm?',   path: '/decision',    desc: 'Interactive decision flowchart' },
      { label: 'Case Studies',       path: '/cases',       desc: 'Real ML deployments explained' },
    ],
  },
  {
    label: 'More',
    color: '#c084fc',
    links: [
      { label: 'Data Matrix',        path: '/data-matrix', desc: 'Algorithm × data type compatibility' },
      { label: 'Performance Guide',  path: '/performance', desc: 'Fix overfitting, underfitting & more' },
    ],
  },
] as const
