...
import { NAV_LINKS, NAV_GROUPS, APP_NAME } from '@constants/index'
          ...
          {!isMobile && (
            <div className="flex items-center gap-1">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-1 z-30 hidden group-hover:block"
                  style={{ width: '560px' }}>
                      ...
                      <div key={group.label}>
                        ...
                        {group.links.map((link) => (
                          <NavLink key={link.path} to={link.path}
                            ...
                            className="flex flex-col px-2 py-2 rounded-lg transition-colors hover:bg-[var(--color-surface-3)]">
